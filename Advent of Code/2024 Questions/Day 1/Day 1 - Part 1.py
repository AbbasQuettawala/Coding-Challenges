...
# Now, finding the difference between each number and putting the distances in sum
total_distance = 0

for i in range(len(right_sorted)):
    difference = left_sorted[i] - right_sorted[i]
    diff_abs = abs(difference)
    total_distance += diff_abs

print("Found the total distance:", total_distance)
